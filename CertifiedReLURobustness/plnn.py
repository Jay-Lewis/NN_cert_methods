...
import time
import copy
from convex_adversarial.convex_adversarial import DualNetwork, DualReLU
# from convex_adversarial import DualNetwork, DualReLU
...
class PLNN(nn.Module):
    ...
    def compute_dual_lp_bounds(self, domain_obj):
        ...
        dual_net = DualNetwork(self.net, midpoint, domain_obj.linf_radius, box_bounds=box_bounds).dual_net
        bounds, dead_set = [], []
        for el in dual_net:
            if isinstance(el, DualReLU):
