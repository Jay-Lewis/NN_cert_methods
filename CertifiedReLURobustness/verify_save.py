...
if __name__ == "__main__":
    ...
    with tf.Session(config=config) as sess:
        ...
        for i in range(len(inputs)):
            ...
            print(
                "[L1] model = {}, seq = {}, id = {}, true_class = {}, target_class = {}, info = {}, robustness_gx = {:.5f}, avg_robustness_gx = {:.5f}, time = {:.4f}, total_time = {:.4f}".format(
                    modelfile, i, true_ids[i], predict_label, target_label, img_info[i], robustness_gx,
