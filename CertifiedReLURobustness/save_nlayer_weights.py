...
class NLayerModel:
    def __init__(self, params, restore=None, session=None, use_log=False, image_size=28, num_classes=10, image_channel=1):
...
class NLayerModel_comparison:
    def __init__(self, params, restore = None, session=None, num_classes=10, use_log=False, image_size=28, image_channel=1):
        ...
        if restore:
            for layer, restore_weights in zip(model.layers, restore):
