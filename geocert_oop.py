...
class IncrementalGeoCert(object):
    ...
    def _pgd_upper_bound(self, x, true_label, lp_norm, num_repeats=32,
                         extra_kwargs=None):
        ...
        pgd_attack = aa.PGD(self.net, normalizer, linf_threat, loss_fxn,
                            manual_gpu=False)
        attack_kwargs = {'num_iterations': 500,
                         'random_init': 0.4,
                         'signed': False,
                         'verbose': False}
    ...
    def min_dist(self, x, lp_norm='l_2', compute_upper_bound=False):
        ...
        return pop_el.lp_dist, adv_bound, adv_ex, best_example, pop_el, self.seen_to_polytope_map.keys()
